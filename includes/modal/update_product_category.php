<div class="modal fade" id="update<?php echo $fetch['id'] ?>" aria-hidden="true" tabindex="-1" aria-labelledby="update">
	<div class="modal-dialog modal-dialog-centered modal-md">
		<div class=" modal-content bg-light">
			<form method="POST" action="includes/modal/update_product_category_query.php">
				...
				<div class="modal-body ml-xl-5 mr-xl-5 mr-lg-5 ml-lg-5 mr-sm-3 ml-sm-3 ml-md-3 mr-md-3 ml-3 mr-3">
					...
					<div class="form-group">
						...
						<input type="hidden" name="prodcat_id" value="<?php echo $fetch['id'] ?>">
						<input class="form-control" type="text" placeholder="Enter Product Category Name" name="prod_cat_name" required="required" value="<?php echo $fetch['name'] ?>">
					</div>
					<div class="form-group mt-2">
						<label for="user_stat"> <span>Status </span> <span class="text-danger"> * </span></label>
