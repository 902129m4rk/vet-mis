<!-- Add Pet Modal -->
<div class="modal fade" id="add_service" aria-hidden="true" tabindex="-1" aria-labelledby="add_service">
    <div class="modal-dialog modal-dialog-centered modal-md">
        <div class=" modal-content bg-light">
            <form action="includes/modal/add_service_query.php" method="POST">
                <div class="modal-header">
                    <h5 class="modal-title">Add Service
                    </h5>
