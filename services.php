            ...
            <div class="d-flex flex-column" id="content-wrapper">
                ...
                <div class="content">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light bg-light top-header">
                        ...
                        <h5 class="navbar-header-text">Services</h5>
                            ...
                            <div class="card-header py-3">
                                <div class="row">
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                        <p class="text-primary m-0 font-weight-normal">Services </p>
                                    </div>
                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                        <div class=" float-lg-right float-md-right float-xl-right float-md-right float-sm-right float-right">
                                            ...
                                            ?>
                                            <button class="btn btn-primary text-light btn-sm " data-toggle="modal" type="button" data-target="#add_service" data-toggle-title="tooltip" data-placement="bottom" title="Add Service">
                                                <i class="fa fa-plus"> </i>
                                                <span class="mobile-icon-only">Add Service</span>
                                            </button>
                                            <?php include 'includes/modal/add_service.php'; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table id="dataTable" class="table table-bordered table-hover" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            $query2 = mysqli_query($conn, "SELECT * FROM `service` ");

                                            while ($fetch = mysqli_fetch_array($query2)) {
                                            ?>
                                                <tr>
                                                    <td><?php if (($fetch['service_id']) <= 9) {
                                                    ...
                                                    <td>
                                                        <button class="btn btn-orange text-light btn-sm action-btn" data-toggle="modal" data-target="#update<?php echo $fetch['service_id'] ?>" data-toggle-title="tooltip" data-placement="bottom" title="Update">
                                            ...
                                            <?php
                                                include 'includes/modal/update_service.php';
                                            }
                                            ?>
                                        </tbody>
